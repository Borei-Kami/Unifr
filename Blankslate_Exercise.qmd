...
<form><label for="ebene1">1. Ebene:</label><br> <input type="text" id="ebene1" name="ebene1"><br> <label for="ebene2">2. Ebene:</label><br> <input type="text" id="ebene2" name="ebene2"><br></form>
